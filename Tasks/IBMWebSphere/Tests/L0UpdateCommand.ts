...
let myAnswers: ma.TaskLibAnswers = <ma.TaskLibAnswers> {
    ...
    'exec': {
        'wsadmin.sh -username myUserName -password myPassword -host myIpAddress.com -port 8879 -conntype SOAP -c AdminConfig.getid(\'/Deployment:deepspace/\');': {
            'code': 0,
            'stdout': 'deepspace(cells/Node01Cell/applications/deepspace.ear/deployments/deepspace|deployment.xml#Deployment_1487188144906)',
            'stderr': undefined
        },
        ...
        'wsadmin.sh -username myUserName -password myPassword -host myIpAddress.com -port 8879 -conntype SOAP -c AdminApp.update(\'deepspace\', \'app\', \'[-operation update -contents /my/deepspace.war -updateOptions myUpdateOptions]\');  AdminConfig.save();': {
            'code': 0,
            'stdout': 'Application deepspace uninstalled successfully. Application deepspace installed successfully.',
            'stderr': undefined
        }
    }
 };
