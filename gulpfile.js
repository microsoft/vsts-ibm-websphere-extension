...
var devManifestOverride = {
    public: false,
    name: "IBM Websphere-Dev",
    id: "ibm-websphere-vsts-extension-dev",
...
gulp.task('packageprod', ['installtaskdeps', 'cleanpackagefiles'], function (cb) {
    ...
    exec('node ./node_modules/tfx-cli/_build/app.js extension create --manifest-globs ibm-websphere-vsts-extension.json --override ' + toOverrideString(prodManifestOverride), function (err, stdout, stderr) {
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
...
gulp.task('packagetest', ['installtaskdeps', 'cleanpackagefiles'], function (cb) {
    ...
    exec('node ./node_modules/tfx-cli/_build/app.js extension create --manifest-globs ibm-websphere-vsts-extension.json --override ' + toOverrideString(devManifestOverride), function (err, stdout, stderr) {
        console.log(stdout);
        console.log(stderr);
        cb(err);
    });
